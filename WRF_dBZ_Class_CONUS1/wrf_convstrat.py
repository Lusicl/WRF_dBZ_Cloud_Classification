# -*- coding: utf-8 -*-
"""
Created on Tue Mar 16 14:51:12 2021
...
def conv_strat_latlon(dbz, lat2d, lon2d, CoreThresh=35.0, method='SYH', a=10, b=100, tune_thresh=35.0, sm_rad=11, fill_dbz=0.0, bg_diff=10):
