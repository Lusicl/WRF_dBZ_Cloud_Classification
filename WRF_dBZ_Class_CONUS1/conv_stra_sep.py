# Convective/Stratiform separation (identification).

# Brody Fuchs, May 2018
# brfuchs@atmos.colostate.edu

# Modifed by Zach Bruick, October 2018, for use with WRF data for RELAMPAGO
# utilizing Hopper and Schumacher (2012) numbers for a, b, and min dBZ for convective classification

# Converting the Yuter and Houze (1998) and the Steiner and Houze (1995)

# Modified by Hungjui Yu, Oct. 2021, for use with Hires WRF CONUS CTRL & PGW runs.
# Make convective masks (1-5) thresholds consistent with header notation.
...
Optional Keywords:
    ...
    a           Tuning variable from YH [8. in YH]
    b           Tuning variable from YH [64. in  YH]
...
Author and history:
    ...
    05 Oct 2021     Make convective masks (1-5) thresholds consistent with header notation.
                    ...
'''
...
def assign_radius(In1, outarray, latarray, lonarray, dist_thresh, box_size, assign_value):
    ...
    #    print d
        ...
        if len(close_d[0]):
            close_d_global = (close_d[0]+lat_ind -
                              box_size, close_d[1]+lon_ind-box_size)
